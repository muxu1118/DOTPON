    ...
    void SetRankingText()
    {
        ...
        switch (rankText)
        {
            case RankText.R1Text:
                ...
                {
                    Rank_Text.text = "x" + MultiPlayerManager.instance.P1Star.ToString();
                }
                else if (MultiPlayerManager.instance.Ranking1 == "2")
                {
                    Rank_Text.text = "x" + MultiPlayerManager.instance.P2Star.ToString();
                }
                else if (MultiPlayerManager.instance.Ranking1 == "3")
                {
                    Rank_Text.text = "x" + MultiPlayerManager.instance.P3Star.ToString();
                }
                else if (MultiPlayerManager.instance.Ranking1 == "4")
                {
                    Rank_Text.text = "x" + MultiPlayerManager.instance.P4Star.ToString();
                }
                break;
