...
public class ChangeDOTPON : MonoBehaviour
{
    ...
    public IEnumerator MoveWheel(int num ,bool plus)
    {
        ...
        while (tim < 10)
        {
            ...
            if (plus)
            {
                Objects[num2].GetComponent<Image>().color = Color.Lerp(Objects[num2].GetComponent<Image>().color, new Color(1, 1, 1, 1), Time.deltaTime * 20);
                Objects[num2].GetComponentInChildren<RawImage>().color = Color.Lerp(Objects[num2].GetComponent<Image>().color, new Color(1, 1, 1, 1), Time.deltaTime * 20);
                ...
                Objects[num3].GetComponent<Image>().color = Color.Lerp(Objects[num3].GetComponent<Image>().color, new Color(1, 1, 1, 0.3f), Time.deltaTime * 20);
                Objects[num3].GetComponentInChildren<RawImage>().color = Color.Lerp(Objects[num3].GetComponent<Image>().color, new Color(1, 1, 1, 0.3f), Time.deltaTime * 20);
                ...
                Objects[num5].GetComponent<Image>().color = Color.Lerp(Objects[num5].GetComponent<Image>().color, new Color(1, 1, 1, 0.3f), Time.deltaTime * 20);
                Objects[num5].GetComponentInChildren<RawImage>().color = Color.Lerp(Objects[num5].GetComponent<Image>().color, new Color(1, 1, 1, 0.3f), Time.deltaTime * 20);
                ...
                Objects[num6].GetComponent<Image>().color = Color.Lerp(Objects[num6].GetComponent<Image>().color, new Color(1, 1, 1, 1), Time.deltaTime * 20);
                Objects[num6].GetComponentInChildren<RawImage>().color = Color.Lerp(Objects[num6].GetComponent<Image>().color, new Color(1, 1, 1, 1), Time.deltaTime * 20);
